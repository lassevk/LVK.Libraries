...
using LVK.Hosting.ConsoleApplications.Attributes;
using LVK.Hosting.ConsoleApplications.GlobalCommands;

namespace LVK.Hosting.ConsoleApplications.Internal;
